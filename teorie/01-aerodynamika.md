...
- **Statický tlak** — tlak okolního vzduchu, působí ve všech směrech stejně. S výškou klesá.
- **Dynamický tlak** — vzniká pohybem vzduchu vůči tělesu (nebo tělesa vůči vzduchu). Roste s **druhou mocninou rychlosti** a s hustotou vzduchu.
- **Celkový tlak** = statický + dynamický.
...
## 4. Obtékání leteckého profilu, vznik vztlaku, závislost na rychlosti obtékání
...
## 5. Úhel náběhu — souvislost se změnami vztlaku a odporu
...
## 6. Vliv změn úhlu náběhu na PK; odtrhávání proudu vzduchu

U padákového kluzáku mění pilot úhel náběhu **brzdami** (zvětšují) a **speed systémem** (zmenšuje):

- **Příliš velký úhel náběhu** (hluboko stažené brzdy, let v silné termice) → odtržení proudu → **přetažení (stall)**.
- **Příliš malý úhel náběhu** (plný speed v turbulenci) → pokles vnitřního tlaku v náběžné hraně → náchylnost k **zaklopení**.
...
## 7. Úplav za křídlem — základní princip vzniku jevu
...
## 9. Rychlostní polára — význam, princip (vztah rychlosti a opadání)

Polára je křivka zobrazující **opadání (svislá osa) v závislosti na dopředné rychlosti (vodorovná osa)**. Z ní lze odečíst:

- **minimální rychlost** (těsně před přetažením),
- **rychlost minimálního opadání** (nejdéle ve vzduchu — kroužení v termice),
- **rychlost nejlepší klouzavosti** (nejdále doletím — tečna z počátku k poláře),
- **maximální rychlost** (trim + plný speed).

Význam: pilot z ní volí optimální režim letu pro danou situaci.

## 10. Klouzavost jako vztah mezi dopřednou a vertikální rychlostí
...
## 11. Vliv větru na klouzavost a rychlost PK vůči zemi a vůči prostředí

Kluzák letí **vůči vzduchu** stále stejně — vítr ale unáší celou vzduchovou hmotu:

- **Protivítr** → nižší rychlost vůči zemi → **horší klouzavost vůči zemi**.
- **Zadní vítr** → vyšší rychlost vůči zemi → **lepší klouzavost vůči zemi**.
- Klouzavost **vůči prostředí (vzduchu)** se větrem nemění.
