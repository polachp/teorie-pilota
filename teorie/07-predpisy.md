...
- **Povinnosti pilota** — létat smí jen držitel platného **pilotního průkazu** (nebo žák pod dozorem instruktora), na kluzáku způsobilém k provozu, a musí mít sjednané **pojištění odpovědnosti za škodu způsobenou provozem SLZ**.
- Pilot odpovídá za to, že letem neohrozí osoby a majetek na zemi ani jiný letový provoz.

> **PK je letadlo ve smyslu zákona — pilot nese právní odpovědnost jako každý jiný velitel letadla.**
...
- **Práva a povinnosti pilota PK** — co smí pilot s danou kvalifikací létat, povinnost respektovat omezení kluzáku (letová a technická způsobilost), povinnosti při provozu na startovištích a přistávacích plochách.
- **Provozní pravidla** — pravidla přednosti mezi PK/ZK (např. na svahu), minimální rozestupy, zákaz letů pod vlivem alkoholu a látek snižujících způsobilost, hlášení letecké nehody.

**Prakticky:** ZL 1 je předpis, se kterým se pilot potkává denně — pravidla svahového létání a přednosti z něj musí umět automaticky.
...
- **Let VFR** — PK létá výhradně **podle pravidel letu za viditelnosti (VFR)**: pilot musí mít stanovenou letovou dohlednost a vzdálenost od oblaků, aby viděl a vyhnul se ostatnímu provozu i překážkám. Let do oblaku je zakázán.
- **Minimální výšky** — nad zástavbou a shromážděním osob platí vyšší minimální výšky letu než nad volným terénem; výjimky se týkají vzletu a přistání.

> **VFR = vidět a být viděn. Odpovědnost za rozstup nese pilot.**
...
- **Zakázané prostory (P)** — vstup trvale zakázán (např. nad citlivými objekty).
- **Omezené prostory (R)** — vstup omezen podmínkami; mimo dobu aktivace bývají průletné.
- **Nebezpečné prostory (D)** — vstup není zakázán, ale probíhá v nich činnost nebezpečná pro let (střelby apod.).
- Kolem neřízených letišť (**ATZ**) platí povinnost sledovat provoz a přizpůsobit se mu.

**Prakticky:** před přeletem si pilot zakreslí trať do aktuální letecké mapy a zkontroluje, které prostory protíná a zda jsou aktivní.
...
**Kde hledat:** letecká informační služba ŘLP ČR, s. p. — webové stránky AIS a zejména aplikace **AisView**, která zobrazuje prostory, AUP i NOTAMy přehledně nad mapou. Řada pilotů PK používá i navigační aplikace, které tato data přebírají — primárním zdrojem ale zůstává AIS.
