...
- **Nasyceně adiabatický gradient** — po kondenzaci se bublina ochlazuje pomaleji, cca **0,6 °C/100 m** (uvolňuje se latentní teplo).
- **Inverze** — teplota s výškou roste; **izotermie** — teplota se s výškou nemění. Obě vrstvy stoupání zastavují.

**Proč to pilota zajímá:** porovnání skutečného gradientu s adiabatickým rozhoduje o **stabilitě vzduchové hmoty** — klesá-li teplota s výškou rychleji, než se ochlazuje stoupající bublina, atmosféra je labilní a funguje termika. Inverze působí jako „víko" termiky.
...
- Na poklesu tlaku s výškou je založen **výškoměr** (barometrický princip) — proto se musí před letem nastavit na správnou vztažnou hodnotu.
...
- **Střední patro** (cca 2–6 km): **altocumulus (Ac)**, **altostratus (As)**.
- **Nízké patro** (do cca 2 km): **stratus (St)**, **stratocumulus (Sc)**, **nimbostratus (Ns)**.
- **Oblaky vertikálního vývoje**: **cumulus (Cu)**, **cumulonimbus (Cb)** — základna nízko, vrchol může sahat přes všechna patra.

Podle vzniku rozlišujeme oblačnost **kupovitou** (konvekční — termika), **vrstevnatou** (výstup na frontách, ustálené počasí) a **řasovitou** (vysoké ledové).
...
- **Ac castellanus** (věžičky) ráno — labilita ve výšce, odpoledne často bouřky.
- **Ac lenticularis** (čočky) — vlnové proudění za horami; hladké vlny, ale pod nimi nebezpečné **rotory**.
- **St, mlha** — stabilní vzduch, inverze, bez termiky.
...
- **Dobře se ohřívají:** tmavé a suché plochy — pole s obilím či strništěm, oranice, skály, písek, jižní svahy, města, parkoviště.
- **Špatně se ohřívají:** vodní plochy, mokré louky, hustý les, sněhová pokrývka, severní svahy.
...
- **Denní chod:** termika se rozbíhá dopoledne (cca 2–3 h po východu slunce), vrcholí časně odpoledne, k večeru slábne a zaniká; večer se mohou uvolňovat zásoby tepla („restituční termika").
- **Roční chod:** nejsilnější a nejostřejší termika bývá **na jaře** (studený vzduch nad prohřátým povrchem = velká labilita), v létě je vydatná ale mírnější, na podzim a v zimě slabá.
...
- **Rychlost větru** odpovídá hustotě izobar: čím **hustší izobary** na synoptické mapě, tím **silnější vítr**.

**Prakticky:** ze synoptické mapy pilot odhadne směr a sílu výškového větru a čeho je aktuální počasí součástí (teplý/studený sektor, blízkost fronty, střed tlakové výše).
...
- **Studená fronta** — studený vzduch se podsouvá pod teplý a prudce ho vytlačuje vzhůru; postupuje rychleji (řádově **30–50 km/h i více**). Přináší Cb, přeháňky, bouřky a **nárazovitý vítr se změnou směru**.
- **Okluzní fronta** — studená fronta dostihne teplou; kombinuje projevy obou.

**Nebezpečí studené fronty v létě:** před frontou bývá dusno a paradoxně výborná, ostrá termika — láká k létání. Fronta ale může dorazit **rychle a s náskokem svých projevů**: húlava (čára instability) s prudkým nárazovitým větrem může předběhnout samotnou frontu o desítky kilometrů. Pro pilota PK platí: **při ohlášené studené frontě včas přistát a nelétat**.
...
- **Noc:** svahy se vyzařováním ochlazují → studený vzduch stéká po svazích dolů (**katabatický vítr**) a údolím ven z hor (**horský vítr**). Studený vzduch se hromadí na dně údolí → ranní **údolní inverze** a mlhy.
...
- Ranní **údolní inverze** termiku zpočátku omezuje na svahy nad ní; po jejím prohřátí a rozpadu se termika rozběhne naplno.
- V sedlech a zúženinách zesiluje vítr (**Venturiho efekt**) — termické kroužení tam snadno přejde v boj s protivětrem.
...
- **Za letu:** snos při kroužení (drift termiky), rozdíl rychlosti vůči zemi po a proti větru, čeření vodních ploch, chování ostatních kluzáků, kouř v údolí.
- Sílu větru lze odhadnout podle projevů v terénu (**Beaufortova stupnice**): např. listí se chvěje ~ slabý vítr; celé větve v pohybu ~ vítr už pro PK nevhodný.

**Prakticky:** PK létá dopřednou rychlostí jen cca 35–50 km/h — vítr srovnatelný s rychlostí kluzáku znamená nulový či záporný postup proti větru. Startovat jen ve větru bezpečně pod rychlostí trimu a počítat se zesilováním s výškou.
...
- **Tvar překážky:** ostré, strmé a členité tvary (skalní hrany, srázy) vytvářejí mohutnější odtržení proudu než pozvolné oblé svahy, které vzduch obteče plynule.
- Turbulentní zóna sahá **po větru do vzdálenosti mnohonásobku výšky překážky** (uvádí se řádově 10–20násobek) a zasahuje i **nad** překážku a mírně **před** ni.

**Prakticky:** nikdy nelétat a nepřistávat nízko v závětří kopce či lesa — rotor může PK zaklopit ve výšce, kde už není prostor na řešení. Vyhýbat se i závětří za jiným hřebenem při silnějším výškovém větru.
...
- **Nasátí do oblaku** — stoupavé proudy pod Cb a v něm mohou dosahovat i přes 10 m/s; hrozí ztráta orientace, námraza, extrémní turbulence. PK se z takového stoupání nemusí dostat.
- **Húlava / gust fronta** — studený vzduch vytékající z bouřky se šíří **desítky kilometrů** před ni a projeví se náhlým prudkým nárazovitým větrem se změnou směru — i pod jasnou oblohou.
- Dále **blesk, kroupy, přívalový déšť** (mokrý vrchlík = zhoršené letové vlastnosti, riziko přetažení) a **downburst** (propad studeného vzduchu).
