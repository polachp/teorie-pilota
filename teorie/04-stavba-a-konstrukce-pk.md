...
- **Karabiny** — spojují volné konce s postrojem.
- **Postroj (sedačka)** — pilotovo „pracoviště": sedací deska/popruhy, zádová opora, **chránič páteře**, schránka na **záložní padák** s uvolňovacím madlem.
...
- **Speed systém** — nožní hrazda propojená přes kladky s volnými konci; sešlápnutím zkracuje přední řady, **zmenšuje úhel náběhu** a zvyšuje rychlost (za cenu menší odolnosti proti zaklopení).
- **Trimy** (spíš u tandemů a PPG) — přestavitelné popruhy měnící trvale nastavení úhlu náběhu bez držení.
- **Postroj a karabiny** — přenášejí váhu pilota, umožňují řízení zatížením (náklonem), chrání pilota (protektor) a nesou **záložní padák** pro případ neřešitelné poruchy kluzáku.
...
- **Šňůry** — kontrolovat poškozený oplet, uzly a hlavně **změny délek** (materiály se srážejí/vytahují — mění se trim křídla i chování při přetažení).
- **Opravy** — drobné vady potahu lze opravit samolepicí záplatou dle pokynů výrobce; **zásahy do nosné konstrukce (šňůry, švy, výměny panelů) patří výhradně autorizovanému servisu** s originálními díly a zkouškou.
- **Záložní padák** — pravidelně přebalovat a kontrolovat propojení s postrojem.

**⚠️ K verifikaci:** doporučený interval přebalování záložního padáku dle výrobce/LAA.
...
- **Obsah prohlídky (typicky):** kontrola porozity a pevnosti tkaniny, pevnosti a délek šňůr (trim), stavu švů, volných konců a příslušenství; výsledkem je protokol a potvrzení způsobilosti, případně předpis oprav.
- **Kdy:** v pravidelných lhůtách daných výrobcem a předpisy LAA ČR, a vždy mimořádně po událostech, které mohly kluzák poškodit (tvrdý dopad, přetržená šňůra, zásah do konstrukce).
- **Odpovědnost:** za způsobilost kluzáku, se kterým letí, odpovídá **pilot (provozovatel)** — létání na kluzáku bez platné prohlídky je porušením předpisů a především hazard.

**⚠️ K verifikaci:** aktuální lhůty a rozsah technických prohlídek dle LAA.
