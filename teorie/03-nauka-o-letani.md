...
- **Zatáčka** — vítr zatáčku vůči zemi „deformuje": část letěná po větru má velký poloměr a vysokou rychlost vůči zemi, část proti větru naopak. Pozor při kroužení nízko u svahu — zatáčka po větru žene pilota k terénu.
- **Rychlost vůči zemi a klouzavost** — protivítr → menší rychlost vůči zemi a horší klouzavost vůči zemi; zadní vítr → opačně. Klouzavost vůči vzduchu se nemění.
- **Přistání** — proti větru: minimální rychlost vůči zemi, krátký doběh, měkký dosed. Rozpočet na přistání stavět tak, aby závěrečná fáze vedla proti větru.
...
2. **Přilba a záložní padák** — přilba nasazená a zapnutá, záložák zajištěný, madlo na svém místě.
3. **Šňůry** — přebrané, volné, nikde uzel, „kravata" ani zachycení o vegetaci; brzdy volně průchozí.
4. **Vrchlík** — rozložený do oblouku, náběžná hrana otevřená, komory nezamotané, náběžnou hranou nahoru.
5. **Vítr a volný prostor** — směr a síla větru vyhovují, startovní i letový prostor volný (piloti ve vzduchu, překážky, lidé na startovišti).

Přesné pořadí a formulace jednotlivých bodů se mohou mezi školami mírně lišit — podstatné je, aby kontrola byla **úplná a vždy stejná**.
...
- **Předpisy a místní pravidla** — kdo terén provozuje, zda je vyžadováno povolení či registrace, místní provozní řád (směry okruhů, zákazy přeletů obcí, ochrana přírody).
- **Meteo** — pro jaké směry a síly větru je terén použitelný, typické místní jevy (rotory za hřebenem, údolní vítr, závětří).
- **Praktická vhodnost** — převýšení, charakter startovky a přistávačky, překážky (dráty, stromy), nouzové přistávací plochy, obtížnost vzhledem k vlastní zkušenosti.

**Prakticky:** nejcennějším zdrojem jsou místní piloti — před prvním letem na novém terénu se vždy vyptat.
...
- Příklady: 36 km/h = 10 m/s; 10 m/s vítr = 36 km/h; opadání 1,2 m/s ≈ 4,3 km/h.
- Rychlý odhad z hlavy: km/h vydělit 4 a přidat desetinu (36 ÷ 4 = 9, + 1 = 10 m/s).
...
- **Vrchlík předlétá** (klopí se dopředu) → krátce přibrzdit, pak brzdy zase povolit.
- **Vrchlík zůstává vzadu** → brzdy povolit (ruce nahoru), nechat křídlo nabrat rychlost; nikdy nebrzdit křídlo, které je za pilotem — hrozí přetažení.
- **Ztráta tlaku na jedné straně** → krátké přibrzdění na této straně a zatížení sedačky, prevence zaklopení.
- Zásahy mají být **krátké a včasné**, ne velké a opožděné — rozhoupaný pilot situaci zhoršuje.
...
- **Vyšší skutečné rychlosti za letu** — všechny režimy (minimální, trimová, maximální rychlost) i opadání jsou ve skutečných hodnotách vyšší; chování kluzáku vůči vzduchu (úhly náběhu, polára „vůči indikované rychlosti") zůstává stejné.
- **Rychlejší přistání** — vyšší dopředná rychlost i opadání při dosednutí → přesnější rozpočet, důsledné dobrždění, počítat s delším výběhem.
- Dynamické manévry (zatáčky, výkruty vrchlíku) probíhají rychleji a ztráta výšky je větší.
...
- **Speed systém** — nožní urychlovač spojený kladkami s předními řadami. Sešlápnutí zkrátí přední řady → zmenší úhel náběhu → vyšší rychlost. Působí jen po dobu sešlápnutí, pilot jej může okamžitě povolit.
- Menší úhel náběhu znamená menší vnitřní tlak v náběžné hraně → **na speedu/povolených trimech je křídlo náchylnější k zaklopení** — v turbulenci speed povolit.
